...
// Но по 2-му пункту может быть вариант с использованием ССЫЛКИ ВМЕСТО КНОПКИ, так как может быть требование
// на тему того, чтобы можно было ссылку на открытую вкладку кому-нибудь отправить, например.
